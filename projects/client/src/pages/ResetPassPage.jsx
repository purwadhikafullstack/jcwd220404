...
const url = `${process.env.REACT_APP_API_BASE_URL}/user/updatePass`;
...
export const ResetPassPage = () => {
    ...
    return move ? (
        ...
        <Stack
            ...
            p={6}
            my={12}>
        <Heading textColor={"black"} lineHeight={1.1} fontSize={{ base: '2xl', md: '3xl' }}>
            Enter new password
        </Heading>
        <FormControl id="password" isRequired>
            <FormLabel textColor={"black"}>Password</FormLabel>
            <Input type="password" w={"230px"}
          textColor="black"
          borderColor={"#285430"} />
        </FormControl>
